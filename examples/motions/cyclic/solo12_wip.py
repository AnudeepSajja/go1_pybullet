...
# IK
gallop.state_wt = np.array([0.0, 0.0, 10.0] + [5000] * 3 + [0.0, 60.0, 60.0] * (pin_robot.model.nv - 6) \
                         + [0.0, 0.0, 0.0]  + [1000] * 3 + [30.0, 30.0, 30.0] * (pin_robot.model.nv - 6))

gallop.ctrl_wt = [0, 0, 1000] + [5e2, 5e2, 5e2] + [1.0] *(pin_robot.model.nv - 6)

gallop.swing_wt = [3*[1e4,], 3*[1e4,]]
gallop.cent_wt = [3*[0*5e+1,], 6*[5e+2,]]
gallop.step_ht = 0.08
gallop.nom_ht = 0.26
...
walk.swing_wt = [3*[1e4,], 3*[1e4,]]
walk.cent_wt = [3*[0*5e+1,], 6*[5e+2,]]
walk.step_ht = 0.05

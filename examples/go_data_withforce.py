...
foot_forces_buffer = np.zeros((4, 3, traj_length), dtype=np.float32)
...
for o in range(simulation_time):    
    ...
    foot_forces = robot.get_ground_reaction_forces()
    ...
    foot_forces_buffer[:, :, buffer_index] = foot_forces
    ...
    if buffer_index==traj_length:
        ...
        foot_forces_data.append(foot_forces_buffer)
...
foot_forces_data = np.concatenate(foot_forces_data, axis=2)

torques_data_buffer = np.concatenate(torques_data, axis=1)

# Define the path for saving
path = "/home/anudeep/devel/workspace/src/data/data_without_noise/"
...
# print("Foot Forces Data Shape:", foot_forces_data.shape)

print("Torques Data Shape:", torques_data_buffer.shape)

# Save the data into a csv file
csv_file = path + 'go1_trot_data_withforce.csv'
...
with open(csv_file, mode='w', newline='') as file:
    ...
    writer.writerow(["time", "base_pos_x", "base_pos_y", "base_pos_z", "base_ori_x", "base_ori_y", "base_ori_z", "base_ori_w",
                     ...
                     "foot_1_norm", "foot_1_lat_x", "foot_1_lat_y",
                     "foot_2_norm", "foot_2_lat_x", "foot_2_lat_y",
                     "foot_3_norm", "foot_3_lat_x", "foot_3_lat_y",
                     "foot_4_norm", "foot_4_lat_x", "foot_4_lat_y",
    ...
    for i in range(foot_contacts_data.shape[1]):
        writer.writerow([i, base_positions_data[0, i], base_positions_data[1, i], base_positions_data[2, i], base_orientations_data[0, i], base_orientations_data[1, i], base_orientations_data[2, i], base_orientations_data[3, i],
                         ...
                         foot_forces_data[0, 0,i], foot_forces_data[0, 1,i], foot_forces_data[0, 2,i],
                         foot_forces_data[1, 0,i], foot_forces_data[1, 1,i], foot_forces_data[1, 2,i],
                         foot_forces_data[2, 0,i], foot_forces_data[2, 1,i], foot_forces_data[2, 2,i],
                         foot_forces_data[3, 0,i], foot_forces_data[3, 1,i], foot_forces_data[3, 2,i],

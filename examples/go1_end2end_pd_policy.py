...
# data_path = "/home/anudeep/devel/workspace/src/data/trot_data_pd_policy_2901/go1_trot_data_actions_eval_oudistri.csv"
...
# robot.start_recording('go1_end2ned_pd_policy_jump.mp4')
...
log_dir = '/home/anudeep/devel/workspace/runs/go1_end2ned_pd_policy_jump'
...
for o in range(num_iterations):
    for i in range(12):  # there are 12 joints/tau values to log
        writer.add_scalars(f'Joint {i+1}', {
            ...
            'Calaculated Torque': predicted_tau[o][i]
        }, o)
